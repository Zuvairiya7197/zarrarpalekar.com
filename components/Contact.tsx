  ...
  return (
    <section id="contact" className="section-padding pb-4 sm:pb-6">
      <Container className="max-w-[1760px]">
        <div className="rounded-[30px] border border-[rgba(185,28,28,0.35)] bg-[rgba(5,2,12,0.94)] px-5 py-6 shadow-[0_30px_90px_rgba(0,0,0,0.28)] sm:px-8 sm:py-8 lg:px-12 lg:py-10">
          <div className="grid gap-6 md:grid-cols-[0.95fr_1.05fr] xl:grid-cols-[0.88fr_1.06fr_0.42fr] xl:items-stretch">
            <div className="flex h-full flex-col px-2 py-2 sm:px-4 lg:px-6 lg:py-6">
              ...
              <h2 className="mt-9 max-w-[420px] text-[30px] font-semibold leading-[1.02] tracking-[-0.05em] text-white sm:text-[48px] lg:text-[56px]">
                ...
                <span className="block">
                  Amazing{" "}
                  <span className="bg-[linear-gradient(90deg,#ef4444,#dc2626)] bg-clip-text font-[family-name:var(--font-script)] text-[1.08em] font-bold text-transparent tracking-normal [text-shadow:0_10px_28px_rgba(239,68,68,0.22)]">
                    Together.
                  </span>
                </span>
              </h2>
              ...
              <div className="mt-8 inline-flex max-w-full flex-wrap items-center gap-3 rounded-full pt-4 sm:mt-auto sm:gap-4 sm:pt-12">
                <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgb(var(--accent))_0%,rgb(var(--accent-secondary))_100%)] text-white shadow-[0_14px_34px_rgba(239,68,68,0.28)]">
            ...
            <div className="rounded-[24px] border border-[rgba(239,68,68,0.34)] bg-[rgba(14,6,22,0.94)] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.28)] sm:p-7">
            ...
            <div className="rounded-[24px] border border-[rgba(239,68,68,0.34)] bg-[rgba(14,6,22,0.94)] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.28)] md:col-span-2 xl:col-span-1">
                ...
                {connectLinks.map((link) => {
                  ...
                  return (
                    ...
                    key={link.label}
                      ...
                      className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[linear-gradient(135deg,rgb(var(--accent))_0%,rgb(var(--accent-secondary))_100%)] text-white shadow-[0_14px_28px_rgba(239,68,68,0.22)] transition-all duration-200 hover:scale-[1.05] hover:shadow-[0_22px_44px_rgba(239,68,68,0.34)] sm:h-14 sm:w-14 md:h-12 md:w-12 xl:h-16 xl:w-16"
                    >
