...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_35px_rgba(37,211,102,0.35)] transition-transform duration-200 hover:scale-[1.04] lg:hidden"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
