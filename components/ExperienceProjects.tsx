                  ...
                  {project.sourceCode ? (
                    <div className="mt-6">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center rounded-full bg-[linear-gradient(90deg,#7f1dff_0%,#9f2eff_100%)] px-5 py-3 text-[14px] font-semibold text-white shadow-[0_14px_34px_rgba(127,29,255,0.32)]"
                      >
